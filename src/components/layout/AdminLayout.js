...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { name: 'Video Scraper', path: '/admin/video-scraper', icon: ArrowPathIcon, access: isFullAdmin },
        ...
        >
          ...
          <div className={`flex items-center justify-between h-16 ${darkMode ? 'bg-[#0c1e4a] border-[#1a2c5c]' : 'bg-white border-gray-200'} border-b px-4`}>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button 
                className={`hidden lg:block p-1 rounded-md ${darkMode ? 'text-white hover:bg-[#132456]' : 'text-gray-700 hover:bg-gray-200'}`}
        ...
        <div className="flex flex-col flex-1 w-full overflow-x-hidden">
          ...
          <header className={`sticky top-0 z-10 flex items-center justify-between h-16 ${
            ...
            <div className="flex items-center">
              <h1 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-800'} hidden sm:block`}>
                Admin Panel
              </h1>
            </div>
            <div className="flex items-center">
